...
SECRET_KEY = 'django-insecure-&j0b#xj2gid!0rd3w3im&$@_aap9(-y#zo+21g^53pdoxhgdrz'
...
ASGI_APPLICATION = 'mensajeria.asgi.application'
...
# Para usar REDIS:
# python -m pip install channels_redis~=3.3
# CHANNEL_LAYERS = [
#     'default': {
